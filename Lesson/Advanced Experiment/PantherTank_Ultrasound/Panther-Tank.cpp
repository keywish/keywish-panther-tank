...
Tank::Tank(ProtocolParser *Package,  uint8_t bin1, uint8_t bin2, uint8_t pwmb, uint8_t standby): SmartCar("Tank", E_AURORA_RACING, 0x01, E_BLUETOOTH_CONTROL)
{
  this->Bin1Pin = bin1;
  this->Bin2Pin = bin2;
  this->PwmbPin = pwmb;
...
Tank::Tank(ProtocolParser *Package, uint8_t ain1, uint8_t ain2, uint8_t pwma, uint8_t bin1, uint8_t bin2, uint8_t pwmb, uint8_t standby): SmartCar("Tank", E_AURORA_RACING, 0x01, E_BLUETOOTH_CONTROL)
{
  this->Ain1Pin = ain1;
  this->Ain2Pin = ain2;
  this->PwmaPin = pwma;
